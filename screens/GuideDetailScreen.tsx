            ...
            <ScrollView>
                ...
                <View className='p-6'>
                    <View className='mb-6'>
                        ...
                        <Text className='text-base font-medium text-gray-800'>{place?.description}</Text>
                    </View>
                    <View className='border-t border-gray-200 pt-4 mb-6'>
                        ...
                        <View className='flex-row items-center mb-3'>
                            ...
                            <Text className='text-gray-800 text-base font-medium ml-3'>Location: {place?.attributes?.location}</Text>
                        </View>
                        <View className='flex-row items-center mb-3'>
                        ...
                        <View className='flex-row items-center mb-3'>
                            ...
                            <Text className='text-gray-800 text-base font-medium ml-3'>Best Time: {place?.attributes?.bestTime}</Text>
                        </View>
                        <View className='flex-row items-center mb-3'>
                            <Ionicons name="star-outline" size={24} color="#FF5722" />
                            <Text className='text-gray-800 text-base font-medium ml-3'>Attractions: {place?.attributes?.attractions.join(", ")}</Text>
                        </View>
                        <View className='flex-row items-center mb-3'>
                            <Ionicons name="cash-outline" size={24} color="#FF5722" />
                            <Text className='text-gray-800 text-base font-medium ml-3'>Entry Fee: {extraAttributes?.entryFee}</Text>
                        </View>
                    </View>
                    {itinerary?.length > 0 && (
                        <View className='border-t border-gray-200 pt-4 mb-6'>
                    ...
                    {extraAttributes?.travelTips?.length > 0 && (
                        <View className='border-t border-gray-200 pt-4 mb-6'>
                            ...
                            {extraAttributes?.travelTips?.map((tip, index) => (
                                <View key={index} className='flex-row items-start mb-2'>
                                    <Text className='text-gray-800 text-base font-medium mr-2'>•</Text>
                                    <Text className='text-gray-800 text-base font-medium'>{tip}</Text>
                                </View>
                            ))}
                        </View>
                    )}
