        ...
        <SafeAreaView className='flex-1 bg-white'>
            ...
            >
                <View className='px-4 py-4 border-b border-gray-200'>
                    <Text className='text-2xl font-bold text-gray-800'>Expolre Karnataka</Text>
                    <Text className='text-sm font-medium text-gray-700 mt-1'>Discover the best places in to visit in Karnataka</Text>
                </View>
